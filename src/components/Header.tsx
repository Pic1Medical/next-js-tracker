...
export default function Header({ signOut, user }: { signOut?: UseAuthenticator["signOut"]; user?: UseAuthenticator["user"] }) {
        ...
        <div className="container-fluid">
          ...
          >
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <NavLink to="/client/inventory/search">Inventory</NavLink>
